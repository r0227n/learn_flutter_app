...
import 'package:youtube_riverpod/src/playlists.dart';
    ...
    return Scaffold(
      ...
      body: Consumer(
        builder: (context, ref, _) {
          final playlistItems = ref.watch(flutterDev).playlistItems(playlistId: playlistId);
          if (playlistItems.isEmpty) return const Center(child: CircularProgressIndicator());
